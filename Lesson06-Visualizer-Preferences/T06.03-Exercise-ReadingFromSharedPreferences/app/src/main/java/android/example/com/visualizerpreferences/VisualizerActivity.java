...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        SharedPreferences defaultSharedPrefernce = PreferenceManager.getDefaultSharedPreferences(this);

        // DONE (3) Get the value of the show_bass checkbox preference and use it to call setShowBass
        mVisualizerView.setShowBass(defaultSharedPrefernce.getBoolean("show_bass", true));
