...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private void makeGithubSearchQuery() {
        ...
        if(githubQuery == null || githubQuery.isEmpty()) {
            Toast.makeText(this, "There isn't anything to search for!", Toast.LENGTH_LONG);
            return;
        }
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                String sUrl = args.getString(SEARCH_QUERY_URL_EXTRA);
                if(sUrl == null || sUrl.isEmpty())
                    return null;

                String githubSearchResults = null;
                URL searchUrl = NetworkUtils.buildUrl(sUrl);
                try {
