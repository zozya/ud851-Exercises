...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String sUrl = mUrlDisplayTextView.getText().toString();
        outState.putString(QUERY_URL, sUrl);

        String sJSON = mSearchResultsTextView.getText().toString();
        outState.putString(RAW_JSON, sJSON);
