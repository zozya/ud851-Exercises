...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        if(this.mNewGuestNameEditText.getText().length() <= 0 || this.mNewPartySizeEditText.getText().length() <= 0)
            return;
        ...
        this.addNewGuest(this.mNewGuestNameEditText.getText().toString(), partySize);

        // DONE (19) call mAdapter.swapCursor to update the cursor by passing in getAllGuests()
        mAdapter.swapCursor(this.getAllGuests());
